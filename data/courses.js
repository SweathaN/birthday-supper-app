window.PB_COURSES = [
  {
    ...
    prepWindow: "All Fri (2 PM block + evening from 5 PM) + overnight dressing; Sat 2:45 PM final topping; assembly 7:00 PM",
    procurement: [
      { day: "Thursday", item: "Shopping only: buy carrots, tamarind, curry leaves; check pantry spices/oil/hing" },
  ...
  },
  {
    ...
    procurement: [
      { day: "Thursday", item: "Shopping only: buy whole milk, thick coconut milk, dark karupatti jaggery, cardamom, sukku, raw whole cashews (100 g), flaky sea salt, 2 oranges, mint, 80 g fresh ginger; check/buy agar-agar, wheat starch, tapioca starch, flour; confirm 13 silicone half-sphere molds" }
    ],
    components: [
      {
